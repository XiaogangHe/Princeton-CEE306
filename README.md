...
**[5-10 mins guide to learn IPython Notebook](http://opentechschool.github.io/python-data-intro/core/notebook.html).** (You can [learn by screencast](https://www.youtube.com/watch?v=qb7FT68tcA8) instead.)

## Places to find great IPython Notebooks:
